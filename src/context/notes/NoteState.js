...
const NoteState = (props) => {
  ...
  const addNote = async (title, description, tag) => {
    ...
    console.log(await response.json()); // To show server response on adding a new note
    //Logic for client side -- NO need of it coz as a new note is added to backend it is refreshing it from backend.
  ...
  const editNote = async (id, title, description, tag) => {
    ...
    console.log(await response.json()); //to store the respose in a const
